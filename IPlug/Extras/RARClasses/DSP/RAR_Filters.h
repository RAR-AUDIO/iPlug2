...
#define SVFMODES_VALIST "LowPass", "HighPass", "BandPass", "Notch", "Peak", "Bell", "LowPassShelf", "HighPassShelf"
    ...
    public:
      ...
      RAR_FilterIIR(EFilterType type, double frequency, double q, double peakGainDB, double samplerate){
    ...
    public:
      RAR_FilterParamSmooth(double smoothingTimeInMs = 10.0, double samplerate = 44100.0){
