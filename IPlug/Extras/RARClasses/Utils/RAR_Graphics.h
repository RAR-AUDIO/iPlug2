...
const IText RAR_DEFAULT_TEXT =
    IText(20.f, RAR_DEFAULT_COLOR, nullptr, EAlign::Center, EVAlign::Top);
const IText RAR_DEFAULT_TEXT_KNOB_LABEL =
    IText(24.f, RAR_DEFAULT_COLOR, nullptr, EAlign::Center, EVAlign::Top);
const IText RAR_DEFAULT_TEXT_KNOB_VALUE =
    IText(20.f, COLOR_MID_GRAY, nullptr, EAlign::Center, EVAlign::Bottom);
const IText RAR_DEFAULT_TEXT_BUTTON_LABEL =
    IText(16.f, RAR_DEFAULT_COLOR, nullptr, EAlign::Center, EVAlign::Bottom);
const IText RAR_DEFAULT_TEXT_BUTTON_VALUE =
    IText(12.f, COLOR_MID_GRAY, nullptr, EAlign::Center, EVAlign::Bottom);
;
const IText RAR_DEFAULT_TEXT_VERSIONSTRING =
    IText(14.f, RAR_DEFAULT_COLOR, nullptr, EAlign::Near, EVAlign::Middle);
const IText RAR_DEFAULT_TEXT_PRESETMENU =
    IText(30.f, RAR_DEFAULT_COLOR, nullptr, EAlign::Center, EVAlign::Middle);

// Color Specs
const IVColorSpec RAR_DEFAULT_COLOR_SPEC = IVColorSpec(
    {RAR_DEFAULT_COLOR_BG, RAR_DEFAULT_COLOR_FG, RAR_DEFAULT_COLOR_PR,
     RAR_DEFAULT_COLOR_FR, RAR_DEFAULT_COLOR_HL, RAR_DEFAULT_COLOR_SH,
     RAR_DEFAULT_COLOR_X1, RAR_DEFAULT_COLOR_X2, RAR_DEFAULT_COLOR_X3});

// Styles
const IVStyle RAR_DEFAULT_STYLE =
    IVStyle(true, true,
            {RAR_DEFAULT_COLOR_BG, RAR_DEFAULT_COLOR_FG, RAR_DEFAULT_COLOR_PR,
             RAR_DEFAULT_COLOR_FR, RAR_DEFAULT_COLOR_HL, RAR_DEFAULT_COLOR_SH,
             RAR_DEFAULT_COLOR_X1, RAR_DEFAULT_COLOR_X2, RAR_DEFAULT_COLOR_X3},
            RAR_DEFAULT_TEXT_KNOB_LABEL, RAR_DEFAULT_TEXT_KNOB_VALUE, true,
            true, true, true,
            0.1f,  // roundness
            2.f,   // frame-thick, def: 1.f
            3.f,   // shadow-off
            DEFAULT_WIDGET_FRAC, DEFAULT_WIDGET_ANGLE);
const IVStyle RAR_DEFAULT_STYLE_KNOB = RAR_DEFAULT_STYLE;
const IVStyle RAR_DEFAULT_STYLE_BUTTON =
    RAR_DEFAULT_STYLE
        /*.WithShowLabel(false)*/
        .WithColor(EVColor::kFG, IColor(255, 30, 50, 70))
        /*.WithDrawShadows(false)*/
        .WithWidgetFrac(0.8f);
const IVStyle RAR_DEFAULT_STYLE_FADER =
    RAR_DEFAULT_STYLE.WithColor(EVColor::kFG, IColor(255, 30, 50, 70))
        .WithDrawFrame(false);
...
class RAR_CustomStyles {
 public:
  ...
  RAR_CustomStyles(IVStyle defaultStyle = DEFAULT_STYLE,
      ...
      : mStyles{defaultStyle, knobStyle,  buttonStyle,
                faderStyle,   meterStyle, graphStyle} {}
...
class RAR_CustomColors {
 public:
  ...
  RAR_CustomColors(IVColorSpec colorSpec, IColor defaultColor,
                   IColor pluginColor, IColor panelColor, IColor blue,
                   IColor red, IColor green, IColor orange, IColor yellow,
                   IColor black, IColor white)
      : mColorSpec(colorSpec), mColors{defaultColor, pluginColor, panelColor,
                                       blue,         red,         green,
                                       orange,       yellow,      black,
                                       white} {}

  IColor GetColor(ECustomColors type = ECustomColors::kDefault) const {
    return mColors[type];
  }
  IColor GetColorWithAlpha(ECustomColors type = ECustomColors::kDefault,
                           float alpha = 255.f) const {
    IColor tempcolor = mColors[type];
    tempcolor.A = alpha;
    return tempcolor;
  }
...
class RAR_CustomTexts {
 public:
  ...
  RAR_CustomTexts(float size, IText defaultText, IText knobLabel,
                  IText knobValue, IText buttonLabel, IText buttonValue,
                  IText versionString, IText presetMenu)
      : mSize(size), mTexts{defaultText, knobLabel,     knobValue, buttonLabel,
                            buttonValue, versionString, presetMenu} {}

  IText GetText(
      RAR::Graphics::Layout::RAR_CustomTexts::ECustomTexts type =
          RAR::Graphics::Layout::RAR_CustomTexts::ECustomTexts::kDefault)
      const {
    return mTexts[type];
  }
  void SetText(RAR::Graphics::Layout::RAR_CustomTexts::ECustomTexts type,
               IText& text) {
    mTexts[type] = text;
  }
...
class RAR_Layout : public RAR_CustomColors,
                   public RAR_CustomTexts,
                   public RAR_CustomStyles {
 public:
  RAR_Layout(RAR_CustomColors colors, RAR_CustomTexts texts,
...
const RAR_CustomColors RAR_DEFAULT_CUSTOM_COLORS = RAR_CustomColors(
    // Color Specs
    IVColorSpec{
        DEFAULT_BGCOLOR,  // Background (DEFAULT_BGCOLOR = COLOR_TRANSPARENT(0,
                          // 0, 0, 0))
        DEFAULT_FGCOLOR,  // Foreground (DEFAULT_FGCOLOR = COLOR_MID_GRAY(255,
                          // 200, 200, 200))
        IColor(255, 234, 158, 19),   // Pressed    (DEFAULT_PRCOLOR =
                                     // COLOR_LIGHT_GRAY(255, 240, 240, 240))
        IColor(255, 150, 150, 150),  // Frame      (DEFAULT_FRCOLOR =
                                     // COLOR_DARK_GRAY(255, 70, 70, 70))
        IColor(30, 255, 255, 255),   // Higlight   (DEFAULT_HLCOLOR =
                                     // COLOR_TRANSLUCENT(10, 0, 0, 0))
        IColor(100, 0, 0,
               0),  // Shadow     (DEFAULT_SHCOLOR = IColor(60, 0, 0, 0)
        IColor(255, 234, 158,
               19),  // Extra 1    (DEFAULT_X1COLOR = COLOR_RED(255, 255, 0, 0))
        IColor(
            255, 48, 166,
            186),  // Extra 2    (DEFAULT_X2COLOR = COLOR_GREEN(255, 0, 255, 0))
        IColor(
            255, 249, 206,
            34),  // Extra 3    (DEFAULT_X3COLOR = COLOR_BLUE(255, 0, 0, 255))
    },
    COLOR_LIGHT_GRAY, IColor(255, 12, 17, 23), IColor(255, 50, 75, 95),
    IColor(255, 62, 100, 121), IColor(255, 131, 18, 18),
    IColor(255, 103, 141, 52), IColor(255, 234, 158, 19),
    IColor(255, 219, 181, 30), IColor(255, 23, 23, 23),
    IColor(255, 243, 243, 243));

const RAR_CustomTexts RAR_DEFAULT_CUSTOM_TEXTS =
    RAR_CustomTexts(DEFAULT_TEXT_SIZE,
                    IText(DEFAULT_TEXT_SIZE,
                          RAR_DEFAULT_CUSTOM_COLORS.GetColor(
                              RAR_CustomColors::ECustomColors::kDefault),
                          nullptr, EAlign::Center, EVAlign::Top),
                    IText(DEFAULT_TEXT_SIZE,
                          RAR_DEFAULT_CUSTOM_COLORS.GetColor(
                              RAR_CustomColors::ECustomColors::kDefault),
                          nullptr, EAlign::Center, EVAlign::Top),
                    IText(DEFAULT_TEXT_SIZE,
                          RAR_DEFAULT_CUSTOM_COLORS.GetColor(
                              RAR_CustomColors::ECustomColors::kDefault),
                          nullptr, EAlign::Center, EVAlign::Bottom),
                    IText(DEFAULT_TEXT_SIZE,
                          RAR_DEFAULT_CUSTOM_COLORS.GetColor(
                              RAR_CustomColors::ECustomColors::kDefault),
                          nullptr, EAlign::Center, EVAlign::Bottom),
                    IText(DEFAULT_TEXT_SIZE,
                          RAR_DEFAULT_CUSTOM_COLORS.GetColor(
                              RAR_CustomColors::ECustomColors::kDefault),
                          nullptr, EAlign::Center, EVAlign::Bottom),
                    IText(1.5f * DEFAULT_TEXT_SIZE,
                          RAR_DEFAULT_CUSTOM_COLORS.GetColor(
                              RAR_CustomColors::ECustomColors::kDefault),
                          nullptr, EAlign::Near, EVAlign::Middle),
                    IText(2.f * DEFAULT_TEXT_SIZE,
                          RAR_DEFAULT_CUSTOM_COLORS.GetColor(
                              RAR_CustomColors::ECustomColors::kDefault),
...
const RAR_CustomStyles RAR_DEFAULT_CUSTOM_STYLE = RAR_CustomStyles(
    ...
    IVStyle(
        true, true,
        {
            DEFAULT_BGCOLOR,            // Background (DEFAULT_BGCOLOR =
                                        // COLOR_TRANSPARENT(0, 0, 0, 0))
            DEFAULT_FGCOLOR,            // Foreground (DEFAULT_FGCOLOR =
                                        // COLOR_MID_GRAY(255, 200, 200, 200))
            IColor(255, 234, 158, 19),  // Pressed    (DEFAULT_PRCOLOR =
                                        // COLOR_LIGHT_GRAY(255, 240, 240, 240))
            IColor(255, 150, 150, 150),  // Frame      (DEFAULT_FRCOLOR =
                                         // COLOR_DARK_GRAY(255, 70, 70, 70))
            ...
            IColor(
                255, 234, 158,
                19),  // Extra 1    (DEFAULT_X1COLOR = COLOR_RED(255, 255, 0, 0)
            IColor(255, 48, 166, 186),  // Extra 2    (DEFAULT_X2COLOR =
                                        // COLOR_GREEN(255, 0, 255, 0))
            IColor(255, 249, 206, 34),  // Extra 3    (DEFAULT_X3COLOR =
                                        // COLOR_BLUE(255, 0, 0, 255))
        },
        RAR_DEFAULT_CUSTOM_TEXTS.GetText(
            RAR_CustomTexts::ECustomTexts::kKnobLabel),
        RAR_DEFAULT_CUSTOM_TEXTS.GetText(
            RAR_CustomTexts::ECustomTexts::kKnobValue),
        true, true, true,
        0.1f,  // roundness
        2.f,   // frame-thick, def: 1.f
        3.f,   // shadow-off
    ...
    IVStyle(
        false, true,
        {
            DEFAULT_BGCOLOR,            // Background (DEFAULT_BGCOLOR =
                                        // COLOR_TRANSPARENT(0, 0, 0, 0))
            IColor(255, 30, 50, 70),    // Foreground (DEFAULT_FGCOLOR =
                                        // COLOR_MID_GRAY(255, 200, 200, 200))
            IColor(255, 234, 158, 19),  // Pressed    (DEFAULT_PRCOLOR =
                                        // COLOR_LIGHT_GRAY(255, 240, 240, 240))
            IColor(255, 150, 150, 150),  // Frame      (DEFAULT_FRCOLOR =
        ...
        RAR_DEFAULT_CUSTOM_TEXTS.GetText(
            RAR_CustomTexts::ECustomTexts::kButtonLabel),
        RAR_DEFAULT_CUSTOM_TEXTS.GetText(
            RAR_CustomTexts::ECustomTexts::kButtonValue),
        true, false, true,
        0.5f,  // roundness
        2.f,   // frame-thick
        3.f,   // shadow-off
    ...
    IVStyle(
        false, true,
        {
            DEFAULT_BGCOLOR,  // Background (DEFAULT_BGCOLOR =
                              // COLOR_TRANSPARENT(0, 0, 0, 0))
            RAR_DEFAULT_CUSTOM_COLORS.GetColor(
                RAR_CustomColors::ECustomColors::
                    kPluginBg),         // Foreground (DEFAULT_FGCOLOR =
                                        // COLOR_MID_GRAY(255, 200, 200, 200))
            IColor(255, 234, 158, 19),  // Pressed    (DEFAULT_PRCOLOR =
                                        // COLOR_LIGHT_GRAY(255, 240, 240, 240))
            IColor(255, 150, 150, 150),  // Frame      (DEFAULT_FRCOLOR =
        ...
        false, true,
        {
            ...
            RAR_DEFAULT_CUSTOM_COLORS.GetColor(
                RAR_CustomColors::ECustomColors::
                    kPluginBg),  // Foreground (DEFAULT_FGCOLOR =
                                 // COLOR_MID_GRAY(255, 200, 200, 200))
            RAR_DEFAULT_CUSTOM_COLORS.GetColorWithAlpha(
                RAR_CustomColors::ECustomColors::kGreen,
                60.f),  // Pressed    (DEFAULT_PRCOLOR = COLOR_LIGHT_GRAY(255,
                        // 240, 240, 240))
            IColor(255, 150, 150, 150),  // Frame      (DEFAULT_FRCOLOR =
                                         // COLOR_DARK_GRAY(255, 70, 70, 70))
            RAR_DEFAULT_CUSTOM_COLORS.GetColorWithAlpha(
                RAR_CustomColors::ECustomColors::kGreen,
                30.f),  // Higlight   (DEFAULT_HLCOLOR = COLOR_TRANSLUCENT(10,
                        // 0, 0, 0))
            IColor(100, 0, 0,
                   0),  // Shadow     (DEFAULT_SHCOLOR = IColor(60, 0, 0, 0)
            RAR_DEFAULT_CUSTOM_COLORS.GetColorWithAlpha(
                RAR_CustomColors::ECustomColors::kGreen,
                60.f),  // Extra 1    (DEFAULT_X1COLOR = COLOR_RED(255, 255, 0,
                        // 0)
            IColor(255, 48, 166, 186),  // Extra 2    (DEFAULT_X2COLOR =
                                        // COLOR_GREEN(255, 0, 255, 0))
            IColor(255, 249, 206, 34),  // Extra 3    (DEFAULT_X3COLOR =
...
const RAR_Layout RAR_DEFAULT_LAYOUT =
    RAR_Layout(RAR_DEFAULT_CUSTOM_COLORS, RAR_DEFAULT_CUSTOM_TEXTS,
               RAR_DEFAULT_CUSTOM_STYLE);

const RAR_Layout layout = RAR_DEFAULT_LAYOUT;

// Maybe we can make something out of this?
struct RAR_Style : public IVStyle {
  RAR_Style(bool showLabel = DEFAULT_SHOW_LABEL,
            bool showValue = DEFAULT_SHOW_VALUE,
            const std::initializer_list<IColor>& colors =
                {DEFAULT_BGCOLOR, DEFAULT_FGCOLOR, DEFAULT_PRCOLOR,
                 DEFAULT_FRCOLOR, DEFAULT_HLCOLOR, DEFAULT_SHCOLOR,
      ...
      : IVStyle(showLabel, showValue, colors, labelText, valueText, hideCursor,
                drawFrame, drawShadows, roundness, frameThickness, shadowOffset,
                widgetFrac, angle) {}
};
}  // namespace Layout
...
class RAR_RoomInfo {
 public:
  RAR_RoomInfo(float lightX = 0.f, float lightY = 0.f, float lightZ = 0.f,
               float plugHeight = 0.f, float plugWidth = 0.f)
  ...
  void Reset(float lightX = 0.f, float lightY = 0.f, float lightZ = 0.f,
             float plugHeight = 0.f, float plugWidth = 0.f) {
  ...
  float GetShadowOffsetX(float cx, float height) const {
    return (cx - mLightX) * height / mLightZ;
  }
  float GetShadowOffsetY(float cy, float height) const {
    return (cy - mLightY) * height / mLightZ;
  }
  IShadow GetShadowForPart(float cx, float cy, float height) {
    return IShadow(EPatternType::Solid, 1.f, GetShadowOffsetX(cx, height),
                   GetShadowOffsetY(cy, height), 0.5f, true);
  }
 ...
 * flexibility, you're on your own! */
class RAR_VectorBase : public IVectorBase, public RAR_RoomInfo {
 public:
  ...
  IRECT GetAdjustedHandleBounds(IRECT handleBounds) const {
    if (mStyle.drawFrame) handleBounds.Pad(-0.5f * mStyle.frameThickness);

    if (mStyle.drawShadows)
      handleBounds.Alter(max(-GetShadowOffsetX(handleBounds.MW(), 10.f), 0.f),
  ...
  virtual void DrawValue(IGraphics& g, bool mouseOver) {
    if (mouseOver) g.FillRect(COLOR_TRANSLUCENT, mValueBounds);

    if (mStyle.showValue)
      g.DrawText(mStyle.valueText, mValueStr.Get(), mValueBounds);
  }

  void DrawHandle(IGraphics& g, EVShape shape, const IRECT& bounds,
    ...
    switch (shape) {
      ...
      case EVShape::EndsRounded:
        DrawPressableRectangle(g, bounds, pressed, mouseOver, true, true, false,
                               false);
        break;
      case EVShape::AllRounded:
        DrawPressableRectangle(g, bounds, pressed, mouseOver, true, true, true,
                               true);
      default:
        break;
    }
  ...
  void DrawPressableCircle(IGraphics& g, const IRECT& bounds, float radius,
                           bool pressed, bool mouseOver) {
    const float cx = bounds.MW(), cy = bounds.MH();

    if (!pressed && mStyle.drawShadows)
      g.FillCircle(GetColor(kSH), cx + mStyle.shadowOffset,
                   cy + mStyle.shadowOffset, radius);

    //    if(pressed)
    //      g.DrawCircle(GetColor(kON), cx, cy, radius * 0.9f, 0,
    //      mStyle.frameThickness);
    //    else
    g.FillCircle(GetColor(kFG), cx, cy, radius);

    if (mouseOver) g.FillCircle(GetColor(kHL), cx, cy, radius * 0.8f);

    if (mStyle.drawFrame)
      g.DrawCircle(GetColor(kFR), cx, cy, radius, 0, mStyle.frameThickness);
  }

  void DrawPressableEllipse(IGraphics& g, const IRECT& bounds, bool pressed,
                            bool mouseOver) {
    if (!pressed && mStyle.drawShadows)
      g.FillEllipse(GetColor(kSH), bounds.GetTranslated(mStyle.shadowOffset,
                                                        mStyle.shadowOffset));
    ...
    if (mouseOver) g.FillEllipse(GetColor(kHL), bounds);
  ...
  /** /todo
   ...
   @return /todo */
  IRECT DrawPressableRectangle(IGraphics& g, const IRECT& bounds, bool pressed,
                               bool mouseOver, bool roundTopLeft = true,
    ...
    if (pressed)
      g.FillRoundRect(GetColor(kPR), handleBounds, topLeftR, topRightR,
                      bottomLeftR, bottomRightR);
    else {
      // outer shadow
      if (mStyle.drawShadows)
        g.FillRoundRect(
            GetColor(kSH),
            handleBounds.GetTranslated(
                GetShadowOffsetX(handleBounds.L + handleBounds.W() * 0.5f,
                                 handleBounds.GetLengthOfShortestSide()),
                GetShadowOffsetY(handleBounds.T + handleBounds.H() * 0.5f,
                                 handleBounds.GetLengthOfShortestSide())),
            topLeftR, topRightR, bottomLeftR, bottomRightR);

      g.FillRoundRect(GetColor(kFG), handleBounds, topLeftR, topRightR,
                      bottomLeftR, bottomRightR);
    }

    if (mouseOver)
      g.FillRoundRect(GetColor(kHL), handleBounds, topLeftR, topRightR,
                      bottomLeftR, bottomRightR);

    if (mControl->GetAnimationFunction()) DrawSplash(g);

    if (mStyle.drawFrame)
      g.DrawRoundRect(GetColor(kFR), handleBounds, topLeftR, topRightR,
                      bottomLeftR, bottomRightR, 0, mStyle.frameThickness);
  ...
  IRECT DrawPressableTriangle(IGraphics& g, const IRECT& bounds, bool pressed,
                              bool mouseOver, float angle) {
    ...
    if (pressed)
      ...
      // outer shadow
      if (mStyle.drawShadows)
        g.FillTriangle(GetColor(kSH), x1 + mStyle.shadowOffset,
                       y1 + mStyle.shadowOffset, x2 + mStyle.shadowOffset,
                       y2 + mStyle.shadowOffset, x3 + mStyle.shadowOffset,
                       y3 + mStyle.shadowOffset);

      g.FillTriangle(GetColor(kFG), x1, y1, x2, y2, x3, y3);
    }

    if (mouseOver) g.FillTriangle(GetColor(kHL), x1, y1, x2, y2, x3, y3);

    if (mControl->GetAnimationFunction()) DrawSplash(g);

    if (mStyle.drawFrame)
      g.DrawTriangle(GetColor(kFR), x1, y1, x2, y2, x3, y3, 0,
                     mStyle.frameThickness);
  ...
  IRECT MakeRects(const IRECT& parent, bool hasHandle = false) {
    ...
    if (!mLabelInWidget) {
      if (mStyle.showLabel && CStringHasContents(mLabelStr.Get())) {
        IRECT textRect;
        mControl->GetUI()->MeasureText(mStyle.labelText, mLabelStr.Get(),
                                       textRect);
    ...
    if (mStyle.showValue && !mValueInWidget) {
      ...
      if (CStringHasContents(mValueStr.Get()))
        mControl->GetUI()->MeasureText(mStyle.valueText, mValueStr.Get(),
                                       textRect);
      ...
      switch (mStyle.valueText.mVAlign) {
        case EVAlign::Middle:
          mValueBounds = clickableArea.GetMidVPadded(textRect.H() / 2.f)
                             .GetMidHPadded(valueDisplayWidth);
          mWidgetBounds = clickableArea.GetScaledAboutCentre(mStyle.widgetFrac);
          break;
        case EVAlign::Bottom: {
          mValueBounds = clickableArea.GetFromBottom(textRect.H())
                             .GetMidHPadded(valueDisplayWidth);
        ...
        case EVAlign::Top:
          mValueBounds = clickableArea.GetFromTop(textRect.H())
                             .GetMidHPadded(valueDisplayWidth);
    ...
    if (mLabelInWidget) mLabelBounds = mWidgetBounds;

    if (mValueInWidget) mValueBounds = mWidgetBounds;
 ...
 protected:
  ...
  //  IRECT mValueBounds; // Text below the contol, usually displaying the value
  //  of a parameter WDL_String mLabelStr; WDL_String mValueStr;
...
class RAR_KnobParts {
 public:
  enum EKnobParts { kLabelring = 0, kFrame, kHandle, kNumKnobParts };

  enum EKnobTypes { kSolid = 0, kChicken, kTec, kMoog, kNumKnobTypes };

  RAR_KnobParts(EKnobParts knobpart, EKnobTypes knobtype, float cx = 0.f,
                float cy = 0.f, float r = 50.f, float lightOffsetX = 0.f,
                float lightOffsetY = 0.f) {
    SetProperties(knobpart, knobtype, cx, cy, r, lightOffsetX, lightOffsetY);
  }

  ~RAR_KnobParts() {}

  void SetProperties(EKnobParts knobpart, EKnobTypes knobtype, float cx,
                     float cy, float r, float lightOffsetX,
                     float lightOffsetY) {
    mKnobtype = knobtype;
    mKnobpart = knobpart;
    mCx = cx;
...
class RAR_VectorKnob : public IKnobControlBase,
  ...
  if (!IsDisabled()) {
    ...
    if (mStyle.drawFrame) {
      ...
      if (mStyle.drawShadows)
        g.FillEllipse(
            GetColor(kSH),
            knobRect.GetPadded(0.5f * frameThickness)
                .GetPadded(max(-shadowOffsetX, 0.f), max(-shadowOffsetY, 0.f),
                           max(shadowOffsetX, 0.f), max(shadowOffsetY, 0.f)));

      g.DrawCircle((!mMouseDown) ? GetColor(kFR) : GetColor(kX1), cx, cy,
                   radius, 0, frameThickness);
    }

    // ARC
    g.DrawArc(
        mUniqueColor, cx, cy, (radius) + 3.f,
        v >= mAnchorAngle ? mAnchorAngle : mAnchorAngle - (mAnchorAngle - v),
        v >= mAnchorAngle ? v : mAnchorAngle, 0, 2.f);

    // WIDGET

    // SHADOW
    if (mStyle.drawShadows)
      g.FillEllipse(GetColor(kSH),
                    knobRect.GetPadded(max(-shadowOffsetX * 0.3f, 0.f),
    ...
    // ARROW
    if (mStyle.drawShadows)
      g.DrawRadialLine(GetColor(kSH), cx + shadowOffsetX * 0.1f,
                       cy + shadowOffsetY * 0.1f, v, 0.0f, radius, 0,
                       arrowThickness >= 1.f ? arrowThickness : 1.f);
    g.DrawRadialLine(GetColor(kFR), cx, cy, v, 0.0f, radius, 0,
                     arrowThickness >= 1.f ? arrowThickness : 1.f);

    // LIGHTPATTERN, Should be optimized
    const IPattern patternLight = IPattern::CreateRadialGradient(
        cx - shadowOffsetX, cy - shadowOffsetY, radius,
...
void RAR_VectorKnob::OnMouseDown(float x, float y, const IMouseMod& mod) {
  if (mStyle.showValue && mValueBounds.Contains(x, y)) {
    ...
    if (mStyle.hideCursor) GetUI()->HideMouseCursor(true, true);
...
void RAR_VectorKnob::OnMouseUp(float x, float y, const IMouseMod& mod) {
  if (mStyle.hideCursor) GetUI()->HideMouseCursor(false);
...
bool RAR_VectorKnob::IsHit(float x, float y) const {
  if (!mDisablePrompt) {
    if (mValueBounds.Contains(x, y)) return true;
  }
...
class RAR_VectorSwitch : public ISwitchControlBase,
...
RAR_VectorSwitch::RAR_VectorSwitch(const IRECT& bounds, int paramIdx,
  ...
  if (valueInButton) mText.mVAlign = mStyle.valueText.mVAlign = EVAlign::Middle;
...
class RAR_VectorToggle : public RAR_VectorSwitch {
 public:
...
class RAR_Logo : public IControl {
 public:
  RAR_Logo(IRECT bounds, const char* str = "", const IText& text = DEFAULT_TEXT,
           const IColor& BGColor = DEFAULT_BGCOLOR)
      : IControl(bounds), mStr(str), mBGColor(BGColor) {
    mIgnoreMouse = true;
    IControl::mText = text;
  }
  ...
  void Draw(IGraphics& g) override {
    ...
    if (mStr.GetLength()) g.DrawText(mText, mStr.Get(), mRECT);
  }
...
class RAR_TrackControlBase : public IControl, public Base::RAR_VectorBase {
 public:
  RAR_TrackControlBase(IRECT bounds, int maxNTracks = 1,
                       float minTrackValue = 0.f, float maxTrackValue = 1.f,
  ...
  void MakeRects() {
    for (int ch = 0; ch < MaxNTracks(); ch++) {
      mTrackBounds.Get()[ch] =
          mRECT.GetPadded(-mOuterPadding)
              .SubRect(EDirection(!(bool)mDirection), MaxNTracks(), ch)
              .GetPadded(0, -mTrackPadding * (float)mDirection,
                         -mTrackPadding * (float)!(bool)mDirection,
                         -mTrackPadding);
    }
  }
  ...
  void Draw(IGraphics& g) override {
    ...
    if (mStyle.drawFrame) DrawFrame(g);
  }

  int NTracks() { return mNTracks; }
  int MaxNTracks() { return mMaxNTracks; }
  void SetTrackData(int trackIdx, float val) {
    mTrackData.Get()[trackIdx] = Clip(val, mMinTrackValue, mMaxTrackValue);
  }
  float* GetTrackData(int trackIdx) { return &mTrackData.Get()[trackIdx]; }
  void SetAllTrackData(float val) {
    memset(mTrackData.Get(), (int)Clip(val, mMinTrackValue, mMaxTrackValue),
           mTrackData.GetSize() * sizeof(float));
  }
 ...
 private:
  ...
  virtual void DrawTrackHandle(IGraphics& g, IRECT& r, int chIdx) {
    ...
    if (mDirection == EDirection::Vertical)
      peakRect =
          IRECT(fillRect.L, fillRect.T, fillRect.R, fillRect.T + mPeakSize);
    else
      peakRect =
          IRECT(fillRect.R - mPeakSize, fillRect.T, fillRect.R, fillRect.B);
  ...
  void OnResize() override { MakeRects(); }
...
class RAR_Meter : public RAR_TrackControlBase {
 public:
  ...
  /** Used on the DSP side in order to queue sample values and transfer data to
   * low priority thread. */
  class RAR_MeterBallistics {
   public:
    RAR_MeterBallistics(int controlTag) : mControlTag(controlTag) {}
    ...
    void ProcessBlock(sample** inputs, int nFrames) {
      ...
      if (mPrevAboveThreshold) mQueue.Push(d);  // TODO: expensive?
    ...
    void TransmitData(IEditorDelegate& dlg) {
      while (mQueue.ElementsAvailable()) {
        Data d;
        mQueue.Pop(d);
        dlg.SendControlMsgFromDelegate(mControlTag, kUpdateMessage,
                                       sizeof(Data), (void*)&d);
      }
    }
  ...
  struct LabelFrames {
    ...
    void SetLabelFrame(IRECT r, float val) {
      str.SetFormatted(MAX_PARAM_DISPLAY_LEN, "%d",
                       static_cast<int>(roundf(val)));
      rectLabel = r;
    }
  };
  ...
  RAR_Meter(IRECT bounds, bool drawFromTop = false, bool drawInverted = false,
            float minDb = 90., float maxDb = 0., float shape = 1.0,
            int markStep = 1, int labelStep = 6, const char* trackNames = 0,
            ...)
      : RAR_TrackControlBase(bounds, MAXNC, DBToAmp(minDb), DBToAmp(maxDb),
                             trackNames),
        ...
        mText(14.f, COLOR_LIGHT_GRAY, DEFAULT_FONT, EAlign::Center,
              EVAlign::Middle, 0.f),
  ...
  void MakeRects() {
    for (int ch = 0; ch < MaxNTracks(); ch++) {
      mTrackBounds.Get()[ch] =
          mRECT.GetPadded(-mOuterPadding)
              ...
              .GetPadded(0, -mTrackPadding,
                         -mTrackPadding * (float)EDirection::Horizontal,
                         -mTrackPadding * (float)EDirection::Vertical);
    }
    ...
    if (mDrawDb) {
      ...
      for (int i = 0, j = 0; i <= mNumLines; i++) {
        const float val = std::roundf(mMinDb + ((float)i / (float)mNumLines) *
                                                   (mMaxDb - mMinDb));
        const float vPosition =
            std::pow<float>((val - mMinDb) / (mMaxDb - mMinDb), 1.0f / mShape);
        mLineCoord[i].SetLine(rectLabelFrame.B - rectLabelFrame.H() * vPosition,
                              1.f);
        if (i % mLabelStep == 0) {
          mLineCoord[i].thickness = mStyle.frameThickness;
          mLabelFrames[j].SetLabelFrame(
              IRECT(rectLabelFrame.L,
                    -mText.mSize + rectLabelFrame.B -
                        vPosition * rectLabelFrame.H(),
                    rectLabelFrame.R,
                    mText.mSize + rectLabelFrame.B -
                        vPosition * rectLabelFrame.H()),
              val);
  ...
  void Draw(IGraphics& g) override {
    ...
    if (mDrawDb) {
      ...
      for (int i = 0; i <= mNumLines; i++) {
        g.DrawLine(GetColor(kHL), rectLabelFrame.L, mLineCoord[i].position,
                   rectLabelFrame.R, mLineCoord[i].position, 0,
                   mLineCoord[i].thickness);
      }
    }
  }
  ...
  virtual void DrawTrackHandle(IGraphics& g, IRECT& r, int chIdx) {
    ...
    if (mDrawDb)
      value = std::pow<float>(
          ((float)AmpToDB(value) - mMinDb) / (mMaxDb - mMinDb), 1.0f / mShape);
    fillRect = r.FracRect(mDirection, (!mDrawInverted) ? value : 1.f - value,
                          mDrawFromTop);  // HERE the value rect is drawn!
    g.FillRect(GetColor(kFG), fillRect);  // TODO: shadows!

    IRECT peakRect;
    if (mDirection == EDirection::Vertical)
      peakRect = (!mDrawFromTop) ? fillRect.GetFromTop(mPeakSize)
                                 : fillRect.GetFromBottom(mPeakSize);
    else
      peakRect = (!mDrawFromTop) ? fillRect.GetFromRight(mPeakSize)
                                 : fillRect.GetFromLeft(mPeakSize);
    DrawPeak(g, peakRect, chIdx);
  }
  ...
  void OnMsgFromDelegate(int messageTag, int dataSize,
...
class RAR_Panel : public IControl {
 public:
  RAR_Panel(IRECT bounds, const IColor& color, bool drawFrame = false)
      : IControl(bounds, kNoParameter), mPattern(color), mDrawFrame(drawFrame) {
    mIgnoreMouse = true;
  }
...
class RAR_PresetMenu : public IControl {
 public:
  ...
  void Draw(IGraphics& g) override {
    ...
    mDisp.SetFormatted(32, "%02d: %s", pNumber + 1,
                       pPluginBase->GetPresetName(pNumber));
  ...
  void OnMouseDown(float x, float y, const IMouseMod& mod) override {
    ...
    if (mod.R) {
      const char* pname =
          pPluginBase->GetPresetName(pPluginBase->GetCurrentPresetIdx());
...
// TODO: Draw with PathConvexShape from ptr to member array updated from
// Updatefunction
class RAR_GraphBase : public IControl, public IVectorBase {
 public:
  RAR_GraphBase(IRECT bounds, int numValues, float* values,
                const IVStyle& style = DEFAULT_STYLE)
      : IControl(bounds, -1),
        IVectorBase(style),
        mValues(values),
  ...
  void Draw(IGraphics& g) override {
    ...
    g.PathMoveTo(mRECT.L, mRECT.MH());
    for (int i = 0; i < mNumValues; i++) {
      // if (mY[i] == mRECT.T && mY[i-1] == mRECT.T || mY[i] == mRECT.B && mY[i
      // - 1] == mRECT.B)
...
// TODO: Draw with PathConvexShape from ptr to member array updated from
// Updatefunction
class RAR_FrequencyResponseMeter : public IControl, public IVectorBase {
 public:
  RAR_FrequencyResponseMeter(IRECT bounds, int numValues, double* values,
                             double shape = 1.0,
                             const IVStyle& style = DEFAULT_STYLE)
      : IControl(bounds, -1),
        IVectorBase(style),
  ...
  void Draw(IGraphics& g) override {
    ...
    for (int i = 0; i < mNumValues; i++) {
      ...
      const float x =
          mRECT.L + ((float)i / ((float)mNumValues - 1.f)) * mRECT.W();
