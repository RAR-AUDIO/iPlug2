...
bool SkSVGNode::parseAndSetAttribute (const char* n, const char* v)
{
    return this->setClipPath (SkSVGAttributeParser::parse<SkSVGClip> ("clip-path", n, v))
           ...
           || this->setFontFamily (SkSVGAttributeParser::parse<SkSVGFontFamily> ("font-family", n, v))
           || this->setFontSize (SkSVGAttributeParser::parse<SkSVGFontSize> ("font-size", n, v))
           || this->setFontStyle (SkSVGAttributeParser::parse<SkSVGFontStyle> ("font-style", n, v))
           || this->setFontWeight (SkSVGAttributeParser::parse<SkSVGFontWeight> ("font-weight", n, v))
           || this->setStroke (SkSVGAttributeParser::parse<SkSVGPaint> ("stroke", n, v))
           || this->setStrokeDashArray (SkSVGAttributeParser::parse<SkSVGDashArray> ("stroke-dasharray", n, v))
           || this->setStrokeLineCap (SkSVGAttributeParser::parse<SkSVGLineCap> ("stroke-linecap", n, v))
           || this->setStrokeLineJoin (SkSVGAttributeParser::parse<SkSVGLineJoin> ("stroke-linejoin", n, v))
           || this->setTextAnchor (SkSVGAttributeParser::parse<SkSVGTextAnchor> ("text-anchor", n, v))
           || this->setVisibility (SkSVGAttributeParser::parse<SkSVGVisibility> ("visibility", n, v));
}
