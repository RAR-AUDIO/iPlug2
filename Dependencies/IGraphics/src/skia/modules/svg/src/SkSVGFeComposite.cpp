...
bool SkSVGFeComposite::parseAndSetAttribute (const char* name, const char* value)
{
    return INHERITED::parseAndSetAttribute (name, value) ||
           ...
           this->setIn2 (SkSVGAttributeParser::parse<SkSVGFeInputType> ("in2", name, value)) || this->setK1 (SkSVGAttributeParser::parse<SkSVGNumberType> ("k1", name, value)) || this->setK2 (SkSVGAttributeParser::parse<SkSVGNumberType> ("k2", name, value)) || this->setK3 (SkSVGAttributeParser::parse<SkSVGNumberType> ("k3", name, value)) || this->setK4 (SkSVGAttributeParser::parse<SkSVGNumberType> ("k4", name, value)) || this->setOperator (SkSVGAttributeParser::parse<SkSVGFeCompositeOperator> ("operator", name, value));
}
