...
namespace internal
{
    EffectBuilder::EffectBuilder (const AnimationBuilder* abuilder,
        ...
        : fBuilder (abuilder), fCompBuilder (cbuilder), fLayerSize (layer_size) {}
    ...
    EffectBuilder::EffectBuilderT EffectBuilder::findBuilder (const skjson::ObjectValue& jeffect) const
    {
        ...
        fBuilder->log (Logger::Level::kWarning, &jeffect, "Unsupported layer effect: %s", mn ? mn->begin() : "(unknown)");
