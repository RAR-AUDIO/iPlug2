...
namespace
{
    ...
    public:
        BrightnessContrastAdapter (const skjson::ArrayValue& jprops,
            ...
            : INHERITED (sksg::ExternalColorFilter::Make (std::move (layer))), fBrightnessEffect (std::get<0> (SkRuntimeEffect::Make (SkString (BRIGHTNESS_EFFECT)))), fContrastEffect (std::get<0> (SkRuntimeEffect::Make (SkString (CONTRAST_EFFECT))))
        {
