    ...
    namespace
    {
        ...
        protected:
            ...
            SkRect onRevalidate (sksg::InvalidationController* ic, const SkMatrix& ctm) override
            {
                ...
                else
                {
                    ...
                    fMaskShader = SkGradientShader::MakeSweep (fWipeCenter.x(), fWipeCenter.y(), grad_colors, grad_pos, SK_ARRAY_COUNT (grad_colors), SkTileMode::kClamp, a0, a1, 0, nullptr);
        ...
        private:
            float wipeAlignment() const
            {
                ...
                {
                    case 1:
                        return 0.0f; // Clockwise
                    case 2:
                        return -360.0f; // Counterclockwise
                    case 3:
                        return -180.0f; // Both/center
                    default:
                        break;
                }
                return 0.0f;
