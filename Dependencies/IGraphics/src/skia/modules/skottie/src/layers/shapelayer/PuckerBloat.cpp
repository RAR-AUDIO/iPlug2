                ...
                switch (verb)
                {
                    ...
                    case SkPath::kLine_Verb:
                    {
                        ...
                        const auto line_start = pts[0],
                                   line_end = pts[1];
                        cubics.push_back ({ lerp (line_start, line_end, kCtrlPosFraction),
                    ...
                    case SkPath::kConic_Verb:
                    {
                        ...
                        cubics.push_back ({ lerp (pts[1], conic_start, kCubicCircleCoeff),
    ...
    std::vector<sk_sp<sksg::GeometryNode>>&& geos)
{
    ...
    for (auto& g : geos)
    {
        bloated.push_back (abuilder->attachDiscardableAdapter<PuckerBloatAdapter> (jround, *abuilder, std::move (g)));
    }
