...
namespace internal
{
    namespace
    {
        ...
        public:
            ...
            FillStrokeAdapter (const skjson::ObjectValue& jpaint,
                               ...
                               Type type)
                : INHERITED (std::move (paint_node)), fShaderType (gradient_adapter ? ShaderType::kGradient : ShaderType::kColor)
            {
    ...
    {
        return abuilder->attachDiscardableAdapter<FillStrokeAdapter> (jpaint,
                                                                      *abuilder,
                                                                      std::move (paint_node),
                                                                      std::move (gradient),
