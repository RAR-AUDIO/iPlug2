...
namespace internal
{
    ...
    struct AnimationBuilder::AttachShapeContext
    {
        AttachShapeContext (std::vector<sk_sp<sksg::GeometryNode>>* geos,
            ...
            : fGeometryStack (geos), fGeometryEffectStack (effects), fCommittedAnimators (committedAnimators) {}
        ...
        for (auto rec = recs.rbegin(); rec != recs.rend(); ++rec)
        {
            ...
            switch (rec->fInfo.fShapeType)
            {
                ...
                case ShapeType::kGeometryEffect:
                {
                    ...
                    SkASSERT (ctx->fGeometryEffectStack->back().fAttach == gGeometryEffectAttachers[rec->fInfo.fAttacherIndex]);
                ...
                case ShapeType::kPaint:
                {
                    ...
                    for (auto it = ctx->fGeometryEffectStack->rbegin();
                         it != ctx->fGeometryEffectStack->rend();
                         ++it)
                    {
                                                                ...
                                                                LayerInfo*) const
    {
        ...
        AttachShapeContext shapeCtx (&geometryStack, &geometryEffectStack, fCurrentAnimatorScope->size());
