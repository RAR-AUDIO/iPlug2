...
namespace internal
{
    namespace
    {
        ...
        public:
            CompTimeMapper (AnimatorScope&& layer_animators,
                            ...
                            float time_bias,
                            float time_scale)
                : fAnimators (std::move (layer_animators)), fRemapper (std::move (remapper)), fTimeBias (time_bias), fTimeScale (time_scale) {}
                                                                  ...
                                                                  LayerInfo* layer_info) const
    {
        ...
        const auto requires_time_mapping = ! SkScalarNearlyEqual (start_time, 0) || ! SkScalarNearlyEqual (stretch_time, 1) || time_remapper;
