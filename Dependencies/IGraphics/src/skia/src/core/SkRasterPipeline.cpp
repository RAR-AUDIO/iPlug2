...
void SkRasterPipeline::append_set_rgb (SkArenaAlloc* alloc, const float rgb[3])
{
    ...
    if (0 <= rgb[0] && rgb[0] <= 1 && 0 <= rgb[1] && rgb[1] <= 1 && 0 <= rgb[2] && rgb[2] <= 1)
    {
        stage = set_rgb;
    }
...
void SkRasterPipeline::append_constant_color (SkArenaAlloc* alloc, const float rgba[4])
{
    ...
    else
    {
        ...
        if (0 <= rgba[0] && rgba[0] <= rgba[3] && 0 <= rgba[1] && rgba[1] <= rgba[3] && 0 <= rgba[2] && rgba[2] <= rgba[3])
        {
...
void SkRasterPipeline::append_matrix (SkArenaAlloc* alloc, const SkMatrix& matrix)
{
    ...
    else if ((mt | (SkMatrix::kScale_Mask | SkMatrix::kTranslate_Mask)) == (SkMatrix::kScale_Mask | SkMatrix::kTranslate_Mask))
    {
...
void SkRasterPipeline::append_load (SkColorType ct, const SkRasterPipeline_MemoryCtx* ctx)
{
    switch (ct)
    {
        ...
        case kAlpha_8_SkColorType:
            this->append (load_a8, ctx);
            break;
        case kA16_unorm_SkColorType:
            this->append (load_a16, ctx);
            break;
        case kA16_float_SkColorType:
            this->append (load_af16, ctx);
            break;
        case kRGB_565_SkColorType:
            this->append (load_565, ctx);
            break;
        case kARGB_4444_SkColorType:
            this->append (load_4444, ctx);
            break;
        case kR8G8_unorm_SkColorType:
            this->append (load_rg88, ctx);
            break;
        case kR16G16_unorm_SkColorType:
            this->append (load_rg1616, ctx);
            break;
        case kR16G16_float_SkColorType:
            this->append (load_rgf16, ctx);
            break;
        case kRGBA_8888_SkColorType:
            this->append (load_8888, ctx);
            break;
        case kRGBA_1010102_SkColorType:
            this->append (load_1010102, ctx);
            break;
        case kR16G16B16A16_unorm_SkColorType:
            this->append (load_16161616, ctx);
            break;
        case kRGBA_F16Norm_SkColorType:
        case kRGBA_F16_SkColorType:
            this->append (load_f16, ctx);
            break;
        case kRGBA_F32_SkColorType:
            this->append (load_f32, ctx);
            break;
...
void SkRasterPipeline::append_load_dst (SkColorType ct, const SkRasterPipeline_MemoryCtx* ctx)
{
    switch (ct)
    {
        ...
        case kAlpha_8_SkColorType:
            this->append (load_a8_dst, ctx);
            break;
        case kA16_unorm_SkColorType:
            this->append (load_a16_dst, ctx);
            break;
        case kA16_float_SkColorType:
            this->append (load_af16_dst, ctx);
            break;
        case kRGB_565_SkColorType:
            this->append (load_565_dst, ctx);
            break;
        case kARGB_4444_SkColorType:
            this->append (load_4444_dst, ctx);
            break;
        case kR8G8_unorm_SkColorType:
            this->append (load_rg88_dst, ctx);
            break;
        case kR16G16_unorm_SkColorType:
            this->append (load_rg1616_dst, ctx);
            break;
        case kR16G16_float_SkColorType:
            this->append (load_rgf16_dst, ctx);
            break;
        case kRGBA_8888_SkColorType:
            this->append (load_8888_dst, ctx);
            break;
        case kRGBA_1010102_SkColorType:
            this->append (load_1010102_dst, ctx);
            break;
        case kR16G16B16A16_unorm_SkColorType:
            this->append (load_16161616_dst, ctx);
            break;
        case kRGBA_F16Norm_SkColorType:
        case kRGBA_F16_SkColorType:
            this->append (load_f16_dst, ctx);
            break;
        case kRGBA_F32_SkColorType:
            this->append (load_f32_dst, ctx);
            break;
...
void SkRasterPipeline::append_store (SkColorType ct, const SkRasterPipeline_MemoryCtx* ctx)
{
    switch (ct)
    {
        ...
        case kAlpha_8_SkColorType:
            ...
            break;
        case kA16_unorm_SkColorType:
            this->append (store_a16, ctx);
            break;
        case kA16_float_SkColorType:
            this->append (store_af16, ctx);
            break;
        case kRGB_565_SkColorType:
            this->append (store_565, ctx);
            break;
        case kARGB_4444_SkColorType:
            this->append (store_4444, ctx);
            break;
        case kR8G8_unorm_SkColorType:
            this->append (store_rg88, ctx);
            break;
        case kR16G16_unorm_SkColorType:
            this->append (store_rg1616, ctx);
            break;
        case kR16G16_float_SkColorType:
            this->append (store_rgf16, ctx);
            break;
        case kRGBA_8888_SkColorType:
        ...
        case kRGBA_1010102_SkColorType:
            ...
            break;
        case kR16G16B16A16_unorm_SkColorType:
            this->append (store_16161616, ctx);
            break;
        case kRGBA_F16Norm_SkColorType:
        case kRGBA_F16_SkColorType:
            this->append (store_f16, ctx);
            break;
        case kRGBA_F32_SkColorType:
            this->append (store_f32, ctx);
            break;
        ...
        case kGray_8_SkColorType:
            this->append (bt709_luminance_or_luma_to_alpha);
            this->append (store_a8, ctx);
            break;
...
void SkRasterPipeline::append_transfer_function (const skcms_TransferFunction& tf)
{
    ...
    switch (classify_transfer_fn (tf))
    {
        ...
        case TFKind::sRGBish_TF:
            ...
            break;
        case PQish_TF:
            this->unchecked_append (PQish, ctx);
            break;
        case HLGish_TF:
            this->unchecked_append (HLGish, ctx);
            break;
        case HLGinvish_TF:
            this->unchecked_append (HLGinvish, ctx);
            break;
    }
}
