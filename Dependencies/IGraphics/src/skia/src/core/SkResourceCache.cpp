...
static inline bool SkShouldPostMessageToBus (
    const SkResourceCache::PurgeSharedIDMessage&,
    uint32_t)
{
...
class SkResourceCache::Hash : public SkTHashTable<SkResourceCache::Rec*, SkResourceCache::Key, HashTraits>
{
};
...
void SkResourceCache::purgeSharedID (uint64_t sharedID)
{
    ...
    SkDebugf ("PurgeShared calls=%d hits=%d rate=%g\n", gPurgeCallCounter, gPurgeHitCounter, gPurgeHitCounter * 100.0 / gPurgeCallCounter);
#endif
}
