...
public:
    ...
    void xfer32 (SkPMColor dst[], const SkPMColor src[], int count, const SkAlpha aa[]) const override
    {
...
bool SkXfermode::IsOpaque (SkBlendMode mode, SrcColorOpacity opacityType)
{
    ...
    switch (dst)
    {
        ...
        case SkBlendModeCoeff::kSA:
            return kTransparentBlack_SrcColorOpacity == opacityType || kTransparentAlpha_SrcColorOpacity == opacityType;
