...
SkCachedData* SkMaskCache::FindAndRef (SkScalar sigma, SkBlurStyle style, const SkRRect& rrect, SkMask* mask, SkResourceCache* localCache)
{
    MaskValue result;
...
void SkMaskCache::Add (SkScalar sigma, SkBlurStyle style, const SkRRect& rrect, const SkMask& mask, SkCachedData* data, SkResourceCache* localCache)
{
    RRectBlurKey key (sigma, rrect, style);
...
public:
        ...
        : fSigma (sigma), fStyle (style)
    {
        ...
        this->init (&gRectsBlurKeyNamespaceLabel, 0, sizeof (fSigma) + sizeof (fStyle) + sizeof (fSizes));
    }
...
SkCachedData* SkMaskCache::FindAndRef (SkScalar sigma, SkBlurStyle style, const SkRect rects[], int count, SkMask* mask, SkResourceCache* localCache)
{
    MaskValue result;
...
void SkMaskCache::Add (SkScalar sigma, SkBlurStyle style, const SkRect rects[], int count, const SkMask& mask, SkCachedData* data, SkResourceCache* localCache)
{
    RectsBlurKey key (sigma, style, rects, count);
