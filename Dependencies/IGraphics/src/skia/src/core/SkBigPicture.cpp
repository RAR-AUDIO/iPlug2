...
SkBigPicture::SkBigPicture (const SkRect& cull,
    ...
    : fCullRect (cull), fApproxBytesUsedBySubPictures (approxBytesUsedBySubPictures), fRecord (std::move (record)), fDrawablePicts (std::move (drawablePicts)), fBBH (std::move (bbh))
{
}
