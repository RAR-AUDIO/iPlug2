...
SkSpriteBlitter* SkSpriteBlitter::ChooseL565 (const SkPixmap& source, const SkPaint& paint, SkArenaAlloc* allocator)
{
...
SkSpriteBlitter* SkSpriteBlitter::ChooseLA8 (const SkPixmap& source, const SkPaint& paint, SkArenaAlloc* allocator)
{
    SkASSERT (allocator != nullptr);
