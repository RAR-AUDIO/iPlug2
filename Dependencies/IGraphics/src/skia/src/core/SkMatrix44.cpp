...
void SkMatrix44::set3x3 (SkScalar m_00, SkScalar m_10, SkScalar m_20, SkScalar m_01, SkScalar m_11, SkScalar m_21, SkScalar m_02, SkScalar m_12, SkScalar m_22)
{
    fMat[0][0] = m_00;
    fMat[0][1] = m_10;
    fMat[0][2] = m_20;
...
void SkMatrix44::set4x4 (SkScalar m_00, SkScalar m_10, SkScalar m_20, SkScalar m_30, SkScalar m_01, SkScalar m_11, SkScalar m_21, SkScalar m_31, SkScalar m_02, SkScalar m_12, SkScalar m_22, SkScalar m_32, SkScalar m_03, SkScalar m_13, SkScalar m_23, SkScalar m_33)
{
    fMat[0][0] = m_00;
    fMat[0][1] = m_10;
    fMat[0][2] = m_20;
...
static void map2_if (const SkScalar mat[][4], const float* SK_RESTRICT src2, int count, float* SK_RESTRICT dst4)
{
...
static void map2_id (const SkScalar mat[][4], const double* SK_RESTRICT src2, int count, double* SK_RESTRICT dst4)
{
    for (int i = 0; i < count; ++i)
    {
        dst4[0] = src2[0];
...
static void map2_tf (const SkScalar mat[][4], const float* SK_RESTRICT src2, int count, float* SK_RESTRICT dst4)
{
...
static void map2_td (const SkScalar mat[][4], const double* SK_RESTRICT src2, int count, double* SK_RESTRICT dst4)
{
    for (int n = 0; n < count; ++n)
    {
...
static void map2_sf (const SkScalar mat[][4], const float* SK_RESTRICT src2, int count, float* SK_RESTRICT dst4)
{
    const float mat32 = float (mat[3][2]);
    for (int n = 0; n < count; ++n)
    {
...
static void map2_sd (const SkScalar mat[][4], const double* SK_RESTRICT src2, int count, double* SK_RESTRICT dst4)
{
    for (int n = 0; n < count; ++n)
    {
...
static void map2_af (const SkScalar mat[][4], const float* SK_RESTRICT src2, int count, float* SK_RESTRICT dst4)
{
    SkScalar r;
    for (int n = 0; n < count; ++n)
    {
...
static void map2_ad (const SkScalar mat[][4], const double* SK_RESTRICT src2, int count, double* SK_RESTRICT dst4)
{
    for (int n = 0; n < count; ++n)
    {
        double sx = src2[0];
...
static void map2_pf (const SkScalar mat[][4], const float* SK_RESTRICT src2, int count, float* SK_RESTRICT dst4)
{
    SkScalar r;
    for (int n = 0; n < count; ++n)
    {
...
static void map2_pd (const SkScalar mat[][4], const double* SK_RESTRICT src2, int count, double* SK_RESTRICT dst4)
{
    for (int n = 0; n < count; ++n)
    {
        double sx = src2[0];
