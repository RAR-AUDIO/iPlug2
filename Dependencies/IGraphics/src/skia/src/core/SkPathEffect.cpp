...
bool SkPathEffect::filterPath (SkPath* dst, const SkPath& src, SkStrokeRec* rec, const SkRect* bounds) const
{
...
bool SkPathEffect::asPoints (PointData* results, const SkPath& src, const SkStrokeRec& rec, const SkMatrix& mx, const SkRect* rect) const
{
...
protected:
    ...
    bool onFilterPath (SkPath* dst, const SkPath& src, SkStrokeRec* rec, const SkRect* cullRect) const override
    {
        SkPath tmp;
