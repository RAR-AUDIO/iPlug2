...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=RARPluginFaust Demo Installer\n"
      else:
        line="OutputBaseFilename=RARPluginFaust Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the RARPluginFaust Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the RARPluginFaust installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=RARPluginFaust Demo installer\n"
     else:
       line="SetupWindowTitle=RARPluginFaust installer\n"
