...
def main():
  ...
  plistpath = scriptpath + "/resources/RARPluginFaust-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RARPluginFaust-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RARPluginFaust-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RARPluginFaust-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/RARPluginFaust-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/RARPluginFaust.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/RARPluginFaust.iss",inplace=1):
