...
def main():
  ...
  plistpath = scriptpath + "/resources/MyFirstPluginRAR-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstPluginRAR-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstPluginRAR-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstPluginRAR-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyFirstPluginRAR-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/MyFirstPluginRAR.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MyFirstPluginRAR.iss",inplace=1):
