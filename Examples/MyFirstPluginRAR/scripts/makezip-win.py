...
def main():
  ...
  if not zip:
    installer = "\\build-win\\installer\\MyFirstPluginRAR Installer.exe"
    
    if demo:
      installer = "\\build-win\\installer\\MyFirstPluginRAR Demo Installer.exe"
    
    files = [
      projectpath + installer,
      projectpath + "\\installer\\changelog.txt",
      projectpath + "\\installer\\known-issues.txt",
      projectpath + "\\manual\\MyFirstPluginRAR manual.pdf" 
    ]
  else:
    files = [
      projectpath + "\\build-win\\MyFirstPluginRAR.vst3\\Contents\\x86_64-win\\MyFirstPluginRAR.vst3",
      projectpath + "\\build-win\\MyFirstPluginRAR_x64.exe"  
    ]
  ...
  files = [
    projectpath + "\\build-win\\pdbs\\MyFirstPluginRAR-vst3_x64.pdb",
    projectpath + "\\build-win\\pdbs\\MyFirstPluginRAR-app_x64.pdb"  
  ]
