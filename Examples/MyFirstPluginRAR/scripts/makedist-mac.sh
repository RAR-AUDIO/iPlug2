...
NOTARIZE_BUNDLE_ID=com.AcmeInc.MyFirstPluginRAR
NOTARIZE_BUNDLE_ID_DEMO=com.AcmeInc.MyFirstPluginRAR.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/MyFirstPluginRAR.iss
#  git checkout installer/MyFirstPluginRAR.pkgproj
