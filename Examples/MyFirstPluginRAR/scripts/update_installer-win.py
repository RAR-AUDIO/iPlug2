...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MyFirstPluginRAR Demo Installer\n"
      else:
        line="OutputBaseFilename=MyFirstPluginRAR Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MyFirstPluginRAR Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MyFirstPluginRAR installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MyFirstPluginRAR Demo installer\n"
     else:
