...
def  main():
  ...
  installer = "\installer\MyFirstPluginRAR Installer.exe"
   
  if demo:
    installer = "\installer\MyFirstPluginRAR Demo Installer.exe"
  ...
  ZIPNAME = "MyFirstPluginRAR-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "MyFirstPluginRAR-v" + FULLVERSIONSTR + "-win-demo.zip"
